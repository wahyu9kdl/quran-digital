                        ...
                        <div class="card-body">
                            <div class="row d-flex justify-content-center">
                                ...
                                <div class="col-7 col-md-5 col-xl-3 align-self-center">
                                    <div class="row mb-3">
                                        <div class="col">
                                            <h1 class="card-text fw-bold" style="cursor: pointer;" onclick="document.location.href = 'index.php';"> القرآن </h1>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12 align-self-center">
                                            <div class="text-start icon">
                                                <a href="https://instagram.com/awfanspage" target="_blank" class="btn btn-light btn-sm me-2">
                                                ...
                                                <a href="https://github.com/login?return_to=https%3A%2F%2Fgithub.com%2Fwahyu9kdl" target="_blank" class="btn btn-light btn-sm me-2">
                                                ...
                                                <a href="https://saweria.co/AwGroupChannel" target="_blank" class="btn btn-light btn-sm">
